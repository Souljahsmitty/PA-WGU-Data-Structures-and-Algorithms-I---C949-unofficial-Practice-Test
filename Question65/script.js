    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The 'IsEmpty()' function checks whether a linked list contains any data or is empty.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: 'IsEmpty()' is used to determine if a linked list contains no elements.";
				feedback.className = "wrong";
			}
        });
    } else {
