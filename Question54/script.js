    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! The 'count()' function returns the number of times a specified value appears in a tuple.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: 'count()' is used to find the occurrence of a specific value in a tuple.";
				feedback.className = "wrong";
        }
        });
    } else {
