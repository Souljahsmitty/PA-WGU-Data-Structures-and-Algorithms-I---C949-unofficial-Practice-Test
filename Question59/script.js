    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Insertion sort places each value into its correct position by iterating through the sorted portion of the list.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: Insertion sort works by iterating through the sorted portion of the list and inserting each new value into its correct position.";
				feedback.className = "wrong";
			}
        });
    } else {
