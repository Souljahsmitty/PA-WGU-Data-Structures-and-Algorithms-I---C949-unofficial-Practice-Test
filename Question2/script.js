    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "D") {
                feedback.textContent = "✔ Correct! An algorithm is independent in nature when it uses an agnostic code repository.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is D: An algorithm is independent in nature when it uses an agnostic code repository.";
                feedback.className = "wrong";
            }
