    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Maintainability refers to the ease with which an algorithm can be updated or modified.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: Maintainability refers to the ease with which an algorithm can be updated or modified.";
				feedback.className = "wrong";
			}
