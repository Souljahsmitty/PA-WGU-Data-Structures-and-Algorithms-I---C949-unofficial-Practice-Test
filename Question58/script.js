    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! The 'remove()' function deletes the first occurrence of a specified element from a list.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: 'remove()' removes the first instance of the specified element from a list.";
				feedback.className = "wrong";
			}
        });
    } else {
