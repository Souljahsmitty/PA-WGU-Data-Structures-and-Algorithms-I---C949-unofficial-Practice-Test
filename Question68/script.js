    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! In a strongly typed language, 'int myVar' explicitly declares an integer variable.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: 'int myVar' ensures strict type enforcement in strongly typed languages.";
				feedback.className = "wrong";
			}
        });
    } else {
