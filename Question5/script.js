    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! Finiteness refers to the property of an algorithm where it must have a stopping condition or end after a finite number of steps.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is D: Finiteness refers to the property of an algorithm where it must have a stopping condition or end after a finite number of steps.";
				feedback.className = "wrong";
			}
