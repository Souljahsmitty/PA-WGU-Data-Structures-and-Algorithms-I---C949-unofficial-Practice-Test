    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! A **record** is a data structure that groups related data items together, typically in a structured format.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **C. Record**. A record allows multiple fields of different types to be stored together as a unit.";
				feedback.className = "wrong";
			}
        });
    } else {
