    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The 'index()' function returns the first occurrence index of a specified value in a tuple.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: 'index()' finds the first occurrence of a value in a tuple.";
				feedback.className = "wrong";
			}
        });
    } else {
