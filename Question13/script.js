    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! Time complexity analysis includes worst-case complexity, which determines the maximum time an algorithm takes in the most demanding scenario.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is D: Time complexity analysis includes worst-case complexity, which determines the maximum time an algorithm takes in the most demanding scenario.";
				feedback.className = "wrong";
			}
        });
    } else {
