    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! A record is a data structure that consists of subitems (fields), each associated with a specific name. It helps organize related data into a single unit.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B: A record is a data structure that consists of subitems (fields), each associated with a specific name. It helps organize related data into a single unit.";
                feedback.className = "wrong";
            }
