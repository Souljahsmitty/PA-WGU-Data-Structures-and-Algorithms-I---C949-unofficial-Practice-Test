    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "C") {
                feedback.textContent = "✔ Correct! A posteriori analysis is conducted after an algorithm has been implemented, using empirical testing to evaluate its real-world performance.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is C. A posteriori analysis is performed post-implementation to assess efficiency using real-world data.";
                feedback.className = "wrong";
            }
        });
    } else {
