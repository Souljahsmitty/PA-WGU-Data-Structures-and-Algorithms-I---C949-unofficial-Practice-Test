document.addEventListener("DOMContentLoaded", function() {
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            feedback.textContent = "✔ Correct! The 'dequeue' operation removes an item from the front of the queue, following FIFO (First In, First Out).";
            feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: 'Dequeue' removes the front item from the queue, following FIFO (First In, First Out).";
				feedback.className = "wrong";
			}
        });
    } else {
