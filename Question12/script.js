    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "C") {
                feedback.textContent = "✔ Correct! Binary Search requires data to be sorted first before performing the search operation.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is C.Binary Search requires data to be sorted first before performing the search operation.";
                feedback.className = "wrong";
            }
        });
    } else {
