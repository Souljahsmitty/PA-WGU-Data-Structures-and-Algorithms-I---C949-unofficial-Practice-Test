    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! **Binary Search** repeatedly divides the data set in half, eliminating one half each step until the target element is found or the data set is exhausted.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: **Binary Search** repeatedly divides the data set in half, eliminating one half each step until the target element is found or the data set is exhausted.";
				feedback.className = "wrong";
			}
        });
    } else {
