    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The pivot in quicksort is typically chosen as the last element in the given range, which in this case is 111.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: The pivot is usually the last element in the range, which is 111.";
				feedback.className = "wrong";
			}
        });
    } else {
