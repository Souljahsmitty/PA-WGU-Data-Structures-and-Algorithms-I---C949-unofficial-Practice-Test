    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A Stack follows the LIFO (Last In, First Out) principle, allowing operations at only one end.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: A Stack operates on the LIFO principle, meaning elements are added and removed from the same end.";
				feedback.className = "wrong";
			}
        });
    } else {
