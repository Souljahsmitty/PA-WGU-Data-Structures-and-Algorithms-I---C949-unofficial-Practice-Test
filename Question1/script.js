    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "B") {
                feedback.textContent = "✔ Correct! A class in programming serves as a blueprint for creating objects.";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is B. A class in programming serves as a blueprint for creating objects.";
                feedback.className = "wrong";
            }
