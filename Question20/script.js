    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "C") {
				feedback.textContent = "✔ Correct! **Interval search (Binary Search)** is the most efficient for sorted data, as it repeatedly divides the dataset in half, achieving an O(log n) time complexity.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is C: **Interval search (Binary Search)** is the most efficient for sorted data, as it repeatedly divides the dataset in half, achieving an O(log n) time complexity.";
				feedback.className = "wrong";
			}
        });
    } else {
