    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The root node is **Anne**, as it is at the top of the tree and all other nodes descend from it.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. Anne**. The root node is the first node in a tree from which all other nodes branch out.";
				feedback.className = "wrong";
			}
        });
    } else {
