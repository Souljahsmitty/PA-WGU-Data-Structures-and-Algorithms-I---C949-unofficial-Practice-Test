    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! A **linked list** is commonly used for simple chaining in hash tables to handle collisions.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **B. Linked List**. Chaining resolves hash collisions by storing multiple elements at the same index in a linked list.";
				feedback.className = "wrong";
			}
        });
    } else {
