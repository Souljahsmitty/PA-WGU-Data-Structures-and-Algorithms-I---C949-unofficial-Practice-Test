    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The 'clear()' function removes all elements from a list, leaving it empty.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: 'clear()' removes all items from a list.";
				feedback.className = "wrong";
			}
        });
    } else {
