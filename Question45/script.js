    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                feedback.textContent = "✔ Correct! A There are 7 numbers, so the middle is position 4 (index 3 in zero-based indexing).The middle number is 9..";
                feedback.className = "correct";
            } else {
                feedback.textContent = "✘ Incorrect. The correct answer is **A. There are 7 numbers, so the middle is position 4 (index 3 in zero-based indexing).The middle number is 9.";
                feedback.className = "wrong";
            }
        });
    } else {
