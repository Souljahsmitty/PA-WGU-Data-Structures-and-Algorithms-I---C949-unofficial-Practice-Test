    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! Merge Sort has an average runtime complexity of O(N*log(N)), making it efficient for large datasets.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is D: Merge Sort has a time complexity of O(N*log(N)), as it recursively divides and merges subarrays.";
				feedback.className = "wrong";
			}
        });
    } else {
