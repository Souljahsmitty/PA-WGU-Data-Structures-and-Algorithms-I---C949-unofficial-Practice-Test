    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct!  82 is the only number in both sets.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. (82)**. 82 is the only number in both sets.";
				feedback.className = "wrong";
			}
        });
    } else {
