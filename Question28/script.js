    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! Enqueue(3)** adds 3 to the end of the queue, resulting in **7,9,8,3**.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: 7,9,8,3**. Enqueue adds elements to the **rear** of the queue.";
				feedback.className = "wrong";
			}
        });
    } else {
