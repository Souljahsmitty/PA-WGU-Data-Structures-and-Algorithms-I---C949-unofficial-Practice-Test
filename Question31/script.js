    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! A **hash table** maps unordered items to specific locations in an array using a hash function.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **D. Hash table**. Hash tables use a hash function to assign each item a position in an array.";
				feedback.className = "wrong";
			}
        });
    } else {
