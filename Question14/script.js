    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The Heap is a special type of Binary Tree (Complete Binary Tree), and Heap Sort uses this structure for sorting.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: The Heap is a special type of Binary Tree (Complete Binary Tree), and Heap Sort uses this structure for sorting.";
				feedback.className = "wrong";
			}
        });
    } else {
