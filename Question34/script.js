    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! The image shows **two** objects.The image clearly shows two distinct objects, making this the correct answer.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is **A. Two**.The image clearly shows two distinct objects, making this the correct answer.";
				feedback.className = "wrong";
			}
        });
    } else {
