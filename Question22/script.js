    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! **hash table** is the primary data structure used to implement a dictionary, allowing for fast key-value lookups.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: **hash table** is the primary data structure used to implement a dictionary, allowing for fast key-value lookups.";
				feedback.className = "wrong";
			}
        });
    } else {
