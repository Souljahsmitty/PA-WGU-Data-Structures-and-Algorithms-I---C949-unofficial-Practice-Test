    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
            ...
            if (selectedAnswer.value === "A") {
                ...
                feedback.textContent = "✘ Incorrect. A posteriori analysis is conducted after an algorithm has been implemented, using empirical testing to evaluate its performance with real-world data.";
                feedback.className = "wrong";
            }
        });
    } else {
