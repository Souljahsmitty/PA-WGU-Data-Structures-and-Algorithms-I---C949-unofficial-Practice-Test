    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! A Stack follows the LIFO (Last In, First Out) principle, where the most recently added item is removed first.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: A Stack operates on the LIFO principle, meaning the last element added is the first to be removed.";
				feedback.className = "wrong";
			}
        });
    } else {
