    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "D") {
				feedback.textContent = "✔ Correct! **Indexes** refer to the numeric positions in a list ADT, allowing direct access to elements.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is D: **Indexes** refer to the numeric positions in a list ADT, allowing direct access to elements.";
				feedback.className = "wrong";
			}
        });
    } else {
