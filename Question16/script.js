    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				feedback.textContent = "✔ Correct! A recursive function is unique because it **calls itself** to break down a problem into smaller subproblems until a base case is met.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is A: A recursive function is unique because it **calls itself** to break down a problem into smaller subproblems until a base case is met.";
				feedback.className = "wrong";
			}
        });
    } else {
