    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "B") {
				feedback.textContent = "✔ Correct! Extensibility refers to an algorithm’s ability to be reused or modified for different applications with minimal changes.";
				feedback.className = "correct";
			} else {
				feedback.textContent = "✘ Incorrect. The correct answer is B: Extensibility refers to an algorithm’s ability to be reused or modified for different applications with minimal changes.";
				feedback.className = "wrong";
			}
        });
    } else {
