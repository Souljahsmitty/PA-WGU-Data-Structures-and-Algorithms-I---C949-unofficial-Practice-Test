    ...
    if (submitButton) {
        submitButton.addEventListener("click", function() {
			...
			if (selectedAnswer.value === "A") {
				...
				feedback.textContent = "✘ Incorrect. The correct answer is **A. Grows and shrinks as needed**. Unlike arrays, linked lists are dynamically allocated and can change size at runtime.";
				feedback.className = "wrong";
			}
        });
    } else {
